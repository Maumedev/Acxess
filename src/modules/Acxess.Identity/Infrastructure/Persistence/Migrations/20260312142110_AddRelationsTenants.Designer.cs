...
{
    [DbContext(typeof(IdentityModuleContext))]
    [Migration("20260312142110_AddRelationsTenants")]
    partial class AddRelationsTenants
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Acxess.Identity.Domain.Entities.TenantsUsers", b =>
                {
                    b.Property<int>("IdTenant")
                        .HasColumnType("int");
                    ...
                    b.HasKey("IdTenant", "UserNumber");

                    b.HasIndex("UserNumber");

                    b.ToTable("TenantsUsers", "Identity");
                });
            ...
            modelBuilder.Entity("Acxess.Identity.Domain.Entities.TenantsUsers", b =>
                {
                    ...
                    b.HasOne("Acxess.Identity.Domain.Entities.ApplicationUser", "User")
                        .WithMany("TenantsUsers")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Acxess.Identity.Domain.Entities.ApplicationUser", null)
                        .WithMany()
